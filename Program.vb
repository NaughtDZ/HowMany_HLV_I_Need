...
Module Program
    ...
    Public Sub caculate()
        ...
        Dim colorA As Color = Color.FromArgb(Console.ReadLine(), Console.ReadLine(), Console.ReadLine()) ' 例如，红色
        Console.WriteLine("请输入目标颜色，依次R\G\B，输入一个数字回车一次")
        Dim colorB As Color = Color.FromArgb(Console.ReadLine(), Console.ReadLine(), Console.ReadLine()) ' 例如，绿色
